    ...
    return (
        <Row>
            <Col className="justify-content-start">
                <PerPageDropdown onChange={(limit) => props.onPerPageChange(limit)} currentLimit={props.currentLimit} limits={props.limits} />
            </Col>
            <Col className="justify-content-end d-flex">
                <PaginationBar pages={props.totalPages} onChange={(page) => props.onPageChange(page)} currentPage={props.currentPage} showMax={props.showMaxPages} />
            </Col>
        </Row>
    );
}
